                    ...
                    if (empty) {
                        ...
                        editButton.setOnAction((ActionEvent event) -> {
                            try {
                                ...
                                Parent root = FXMLLoader.load(getClass().getResource("EditStudentForm.fxml"));
                        ...
                        removeButton.setOnAction((ActionEvent event) -> {
                            ...
                            try {
                                if (alert.confirmationMessage("Are you sure you want to delete Patient ID: " + pData.getStudentID() + "?")) {
